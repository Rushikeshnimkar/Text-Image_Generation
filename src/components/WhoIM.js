...
//               Hi Everyone, I am <span className="text-[#ad50eb]"> Rushikesh </span>{" "}
//               from <span className="text-[#ad50eb]">Nagpur, India</span>
//             </p>
//             <p className="lg:text-xl font-thin ">
//               Greetings everyone! I'm Rushikesh, a BE comp student at Pune 
